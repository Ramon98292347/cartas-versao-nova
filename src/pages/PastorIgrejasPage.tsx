...
// Comentario: pagina exclusiva de igrejas para pastor com o mesmo componente de gestao.
export default function PastorIgrejasPage() {
  const [page, setPage] = useState(1);
  const [pageSize, setPageSize] = useState(20);

  const { data } = useQuery({
    queryKey: ["pastor-igrejas-page", page, pageSize],
  ...
  return (
    <ManagementShell roleMode="pastor">
      <div className="mb-4">
        ...
        <p className="mt-1 text-3xl font-medium text-slate-600">Gerencie as igrejas da sua região</p>
      </div>

...
-- Passo 2: converte placeholders inválidos para NULL
UPDATE users SET minister_role = NULL WHERE minister_role IN ('-', '', ' ');

-- Passo 3: normaliza outros valores para capitalização correta
...
-- Passo 4: adiciona CHECK constraint com valores permitidos
